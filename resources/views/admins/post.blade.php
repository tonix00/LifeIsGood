...
@section('content')
<form action="{{url('/')}}/admin/addpost" class="form" enctype="multipart/form-data" method="post">
    {{csrf_field()}}
    ...
    <div class="form-textarea">
        <textarea id="inquiry" cols="30" rows="10" name="content" class="input input-contents"></textarea>
    </div>
    @if(count($errors)>0)
